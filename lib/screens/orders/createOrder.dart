...
class atCreateOrder extends StatefulWidget {
  atCreateOrder({Key? key}) : super(key: key);
  @override
  _atCreateOrder createState() => _atCreateOrder();
}

class _atCreateOrder extends State<atCreateOrder>
  ...
  double totalOrderAfterDiscount = 0.0;
  double moneydiscount = 0.0;
  ...
  Future createOrder() async {
    ...
    FirebaseFirestore.instance.collection('orders').add({
      ...
      'type': 'Invoice',
      'total': totalOrderAfterDiscount.toStringAsFixed(0).toString(),
      'timeDetail':
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: "Write the name of receiver",
                            filled: true,
                            fillColor: blueLight,
